...
/**
 * POJO mapping all coins list response
 */
class CryptoCurrencyList: ResponsePOJO {
    ...
    /**
     * POJO mapping one coin from all coins list response
     */
    class CryptoCurrency {
        // summary(basic) attributes
        @SerializedName("Id")
        @Expose
        @Pos(1)
        val id: String? = null
        ...
        @Expose
        @Pos(15)
        val netHashesPerSecond: Float? = null
        ...
        /**
         * Class representing one field of CryptoCurrency class
         */
        class CryptoField(val label: String, val value: String)

        /* get field names & values through reflection */
        ...
        /* filter empty & not empty but invalid field values  */
